...
func TestService_Generate_WhitespacePrompt(t *testing.T) {
...
func TestService_Generate_OllamaError(t *testing.T) {
	mockOllama := &mocks.MockOllama{Error: errors.New("fail")}
	mockLogger := &mocks.MockLogger{}
	g := &service{ollama: mockOllama, logger: mockLogger}
	resp, err := g.Generate("prompt")
	if err == nil || resp != "" {
